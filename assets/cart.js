// Règles du panier : validation des données du navigateur, ajout, total.
// Une ligne « PDF » ne se duplique pas, les exemplaires imprimés se cumulent.
import { formats, getKit } from './catalog.js';
...
export function addToCart(items, kitId, format) {
